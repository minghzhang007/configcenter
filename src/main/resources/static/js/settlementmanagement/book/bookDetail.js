...
VM = new Vue({
    ...
    methods: {
        queryMonth: function () {
            ...
            var bookObject = JSON.parse($("#book").text());

            $.ajax({
                url: url + "/book/query/month",
                type: "GET",
                dataType: "JSON",
                data: JSON.stringify($.extend(formData, bookObject)),
        ...
        queryDay: function () {
            ...
            $.ajax({
                url: url + "/book/query/day",
                type: "GET",
                dataType: "JSON",
                data: JSON.stringify($.extend(bookObject, formData)),
                success: function (data) {
                    _this.result = data;
                }
            });
