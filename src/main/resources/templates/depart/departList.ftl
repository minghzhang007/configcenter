        ...
        <div class="row">
            <div class="form-group">
                ...
                <div class="col-md-3">
                    ...
                    <button type="button" class="btn btn-primary" @click="add"> <i class="fa fa-plus"></i>新增部门
                    </button>
                </div>
            </div>
        </div>
...
<script type="text/javascript" src="${request.contextPath}/js/depart/departList.js"></script>
